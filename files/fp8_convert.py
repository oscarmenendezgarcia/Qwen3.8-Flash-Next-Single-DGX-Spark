# Vendored for reproducibility: docs/checkpoint-quantization-and-spanish-2026-09-14.md
# section 6 depends on it. Taken from blazux/qwen3.8-Flash-DGX (tools/fp8_convert.py,
# Apache-2.0), which took it from Saren-Arterius/qwen3.8-Flash-DGX-AutoRound.
