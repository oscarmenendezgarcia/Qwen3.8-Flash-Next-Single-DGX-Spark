#!/usr/bin/env python3
"""Benchmark de Flash-Next replicando el protocolo publicado por sojufx,
para que nuestros numeros sean comparables con los suyos y los de Mia.

Su protocolo (README de sojufx/sojufx-Qwen3.8-Flash-Next):
