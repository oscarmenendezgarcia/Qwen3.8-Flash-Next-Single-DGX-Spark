...
# The two recipe checkouts. Overridable so the script is not pinned to one
# home directory; defaults match this box.
QWEN_RECIPE="${QWEN_RECIPE:-$HOME/qwen38-recipe}"
FN_RECIPE="${FN_RECIPE:-$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)}"
